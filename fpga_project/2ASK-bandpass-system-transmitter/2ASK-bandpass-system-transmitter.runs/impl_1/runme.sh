...
HD_PWD='D:/Desktop/2ASK_FPGA/2ASK-bandpass-system-transmitter/fpga_project/2ASK-bandpass-system-transmitter/2ASK-bandpass-system-transmitter.runs/impl_1'
cd "$HD_PWD"
