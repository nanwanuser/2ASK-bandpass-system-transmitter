...
#
# Generated by Vivado on Tue Jun 24 21:32:12 +0800 2025
...
# Script info
echo -e "fir.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_9 -L axi_utils_v2_0_5 -L fir_compiler_v7_2_11 -L xil_defaultlib -L secureip -L xpm --snapshot fir xil_defaultlib.fir -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fir -key {Behavioral:sim_1:Functional:fir} -tclbatch cmd.tcl -log simulate.log
}
