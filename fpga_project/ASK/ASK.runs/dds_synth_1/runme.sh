...
HD_PWD='D:/Desktop/2ASK_FPGA/2ASK-bandpass-system-transmitter/fpga_project/ASK/ASK.runs/dds_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds.tcl
