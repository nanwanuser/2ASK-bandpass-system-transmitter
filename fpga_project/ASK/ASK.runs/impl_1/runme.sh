...
HD_PWD='D:/Desktop/2ASK_FPGA/2ASK-bandpass-system-transmitter/fpga_project/ASK/ASK.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_2ask_transmitter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_2ask_transmitter.tcl -notrace
